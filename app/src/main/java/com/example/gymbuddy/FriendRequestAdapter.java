...
public class FriendRequestAdapter extends ArrayAdapter<User> implements View.OnClickListener {
    ...
    public FriendRequestAdapter(ArrayList<User> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FriendRequestAdapter.ViewHolder viewHolder;
        final View result;
        if (convertView == null){
